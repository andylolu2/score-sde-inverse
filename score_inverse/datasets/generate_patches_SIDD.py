# https://github.com/swz30/MIRNet/blob/master/generate_patches_SIDD.py
...
parser.add_argument('--src_dir', default='../data/sidd/Data', type=str, help='Directory for full resolution images')
